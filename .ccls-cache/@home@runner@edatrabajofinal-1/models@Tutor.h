...
public:
  ...
  Tutor(const string &error) { this->ExisteError = error; }
  Tutor(const string &nombre, const string &contra, const string &aula,
  ...
  Tutor(const string &nombreAlumno, const string &contrasena,
